            ...
            <form className='flex items-start justify-between flex-wrap w-full'>
                <div className='w-1/2'>
                    ...
                    <div>
                        ...
                        <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-grey-400 mb-4' type="text" placeholder='Empolyee name' />
                    </div>
                    <div>
                ...
                <div className='w-2/5 flex flex-col items-start'>
                    ...
                    <textarea className='w-full h-44 text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-grey-400 mb-4' name="" id="" cols="30" rows="10"></textarea>
